...
<section class="container">
    <div class="row aling-items-center">
                        ...
                        <form method="POST" action="{{ route('gastos.store') }} " class="mx-auto px-4 needs-validation" novalidate>
                            ...
                            <div class="mb-3">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="number" name="Monto" min="0" max="100000" step="0.01" pattern="\d+(\.\d{2})?" placeholder="Bs." required>
                                </div>
                                <div class="valid-feedback">
                                    Todo bien c:!
                                </div>
        ...
        <div class="col-xl-6 d-none d-xl-block">
            <img src="{{ asset('imagenesApoyo/crear-gasto.png') }}" style="width: 90%;">
        </div>
    </div>
</section>
