...
<section class="container">
    <section class="row aling-items-center">
        <div class="col col-md-6">
            ...
            <form method="POST" action="{{ route('gastos.store', $gasto->id) }} " class="mx-auto px-4 needs-validation" novalidate>
                @csrf
                ...
                <div class="mb-3">
                    <div class="form-group">
                        ...
                        <input type="number" name="Nro_de_comprobante" class="form-control" placeholder="Ejemplo: N°12345678" value="{{$gasto->Nro_de_comprobante}}" required>
                    </div>
                    <div class="valid-feedback">
                        Todo bien c:!
                    </div>
